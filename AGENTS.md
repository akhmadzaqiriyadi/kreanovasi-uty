...
Welcome agent! You are pair-programming with the user on the UCH Web App project. Please adhere to these guidelines to ensure consistency, clean execution, and high-fidelity code architecture.
