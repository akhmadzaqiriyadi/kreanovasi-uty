  ...
  return (
    <header
      ...
      className={cn(
        ...
        scrolled
          ? "bg-background/90 dark:bg-background/90 backdrop-blur-xl border-b border-border/80 shadow-xs h-16"
          : "bg-background/95 border-b border-border/40 h-20",
      )}
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl h-full flex items-center justify-between">
        {/* Brand Logo */}
        <Link
          ref={logoRef}
          href="/"
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={cn(
                  "relative text-sm font-semibold whitespace-nowrap transition-colors py-1.5 px-3 rounded-lg text-primary",
                  active
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                type="button"
                className={cn(
                  "relative text-sm font-semibold whitespace-nowrap flex items-center gap-1 py-1.5 px-3 rounded-lg transition-colors cursor-pointer text-primary",
                  isProgramActive()
                    ? "text-primary font-bold bg-primary/10"
                    : "text-primary/85 hover:text-primary hover:bg-primary/5",
                )}
        ...
        >
          ...
          <Link
            ...
            className={cn(
              ...
              "border-primary/40 text-primary hover:bg-primary/10 font-semibold rounded-xl whitespace-nowrap transition-colors h-9 px-4 text-xs sm:text-sm",
            )}
          >
            Cek Jadwal
          </Link>
          ...
          <Link
            ...
            className={cn(
              ...
              "bg-primary hover:bg-primary/90 text-primary-foreground font-semibold shadow-xs rounded-xl whitespace-nowrap transition-colors flex items-center gap-1.5 h-9 px-4 text-xs sm:text-sm",
            )}
          >
