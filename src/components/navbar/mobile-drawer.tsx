          ...
          <div className="p-4 border-t border-border/50 bg-slate-50/60 dark:bg-zinc-900/60 space-y-3">
            {isLoggedIn ? (
              ...
              <div className="space-y-2.5">
                <div className="p-3 rounded-xl bg-white dark:bg-zinc-800/80 border border-border/60 text-center">
                  <p className="text-xs font-semibold text-foreground">
                    Belum masuk akun?
                  </p>
                  <p className="text-[11px] text-muted-foreground mt-0.5">
                    Masuk atau buat akun untuk booking ruangan & akses tiket.
                  </p>
                </div>
                <div className="grid grid-cols-2 gap-2">
                  <Button
                    ...
                    className="w-full h-9 rounded-xl text-xs font-bold bg-primary text-primary-foreground hover:bg-primary/90 flex items-center justify-center gap-1.5 cursor-pointer"
                  >
                  ...
                  <Button
                    ...
                    className="w-full h-9 rounded-xl text-xs font-bold border-primary/30 text-primary hover:bg-primary/10 flex items-center justify-center gap-1.5 cursor-pointer"
                  >
