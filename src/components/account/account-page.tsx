              ...
              <div className="flex flex-col sm:flex-row sm:items-end gap-3 sm:gap-4">
                ...
                <div className="space-y-0.5 sm:space-y-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <Badge
                      variant="secondary"
                      className="text-[10px] sm:text-xs font-bold py-0.5 px-2 bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-blue-300 border-none"
                    >
                      {formData.role}
                    </Badge>
                  </div>
